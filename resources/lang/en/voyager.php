...
return [
    ...
    'login' => [
        ...
        'welcome'      => 'Welcome to Tajluxury villa',
    ],
    ...
    'dimmer' => [
        ...
        'contact_link_text' => 'View all messages',
        'contact_text'      => 'You have :count :string ',

        'rdv'           => 'Appointment required|Aappointments required',
        'rdv_link_text' => 'View all requists',
        'rdv_text'      => 'You have :count :string  ',

        'rapple'           => 'Call Back|Calls Back',
        'rapple_link_text' => 'View all requists',
        'rapple_text'      => 'You have :count :string ',
