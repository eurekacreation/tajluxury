...
return [
    ...
    'login' => [
        ...
        'welcome'      => 'Bienvenue sur Tajluxury villa',
    ],
    ...
    'dimmer' => [
        ...
        'contact'           => 'Message recu|Messages recus',
        'contact_link_text' => 'Voir toutes les messages',
        'contact_text'      => 'Vous avez :count :string sur la boite de reception.',

        'rdv'           => 'Rendez-vous demandé|Rendez-vous demandés',
        'rdv_link_text' => 'Voir toutes les Demandes',
        'rdv_text'      => 'Vous avez :count :string dans la agenda par nos clients ',

        'rapple'           => 'Demande d\'etre rappelé|Demandes d\'etre rappelé',
        'rapple_link_text' => 'Voir toutes les demendes',
        'rapple_text'      => 'Vous avez :count :string envoyées par nos visiteurs',
