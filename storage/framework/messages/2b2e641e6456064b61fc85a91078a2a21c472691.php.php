...
<head>
    ...
    <title>Admin - TAJLUXURY VILLA</title>
    ...
    <style>
        ...
        .login-sidebar{
            border-top:5px solid <?php echo e(config('voyager.primary_color','#ad946a')); ?>;
        }
        @media (max-width: 767px) {
            .login-sidebar {
                border-top:0px !important;
                border-left:5px solid <?php echo e(config('voyager.primary_color','#ad946a')); ?>;
            }
        }
        body.login .form-group-default.focused{
            border-color:<?php echo e(config('voyager.primary_color','#ad946a')); ?>;
        }
        .login-button, .bar:before, .bar:after{
            background:<?php echo e(config('voyager.primary_color','#ad946a')); ?>;
        }
    </style>
...
<div class="container-fluid">
    <div class="row">
            ...
            <div class="clearfix">
                <div class="col-sm-12 col-md-10 col-md-offset-2">
                    <div class="logo-title-container">
                        ...
                        <img style="max-width: 140px;" class="img-responsive pull-left logo hidden-xs animated fadeIn" src="<?php echo e(voyager_asset('images/logo-icon-light.png')); ?>" alt="Logo Icon">
                        <?php else: ?>
                        <img style="max-width: 140px;" class="img-responsive pull-left logo hidden-xs animated fadeIn" src="<?php echo e(Voyager::image($admin_logo_img)); ?>" alt="Logo Icon">
                        <?php endif; ?>
        ...
        <div class="col-xs-12 col-sm-5 col-md-4 login-sidebar" style="    background: #ffffffe6;">
