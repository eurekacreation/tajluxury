...
<?php $__env->startSection('css'); ?>
        <link rel="stylesheet" href="<?php echo e(asset('frontend/css/jssor.css')); ?>" type="text/css" />
...
<?php $__env->startSection('content'); ?>
            ...
            <div class="page-title wow fadeIn clearfix">
                <div class="title text-center wow fadeIn" data-wow-delay="1.5s">
                    <p class="subtitle"><?php echo e(_i('A propos de')); ?></p>
                    <h2><?php echo e(_i('Notre')); ?> <span class="bold"><?php echo e(_i('Villa')); ?></span></h2>
                </div>
            </div>
            <!-- PAGE TITLE END -->
            ...
            <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:980px;height:380px;overflow:hidden;visibility:hidden;">
                ...
                <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:980px;height:380px;overflow:hidden;">
                    ...
                    <div data-p="170.00">
                        ...
                        <div data-u="thumb">
                            <span class="d"><?php echo e($room->getTranslatedAttribute('title')); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="room-detail widget col-md-6">
                                <h3 class="widget-title"><?php echo e(_i('ÉQUIPEMENTS')); ?></h3>

                                <div class="col-lg-12  col-xs-12">
                                    <ul class="room-service">
                                        <div class="col-lg-6  col-xs-12"><li>
                                            <i class="flaticon2-air-conditioner"></i><?php echo e(_i('Climatisation')); ?>

                                        </li></div>
                                        <div class="col-lg-6  col-xs-12"><li>
                                            <i class="flaticon2-bars"></i><?php echo e(_i('Balcons')); ?>

                                        </li></div>
                                        <div class="col-lg-6  col-xs-12"><li>
                                            <i class="flaticon2-people-2"></i><?php echo e(_i('Piscine')); ?>

                                        </li></div>
                                        <div class="col-lg-6  col-xs-12"><li>
                                            <i class="flaticon2-monitor"></i><?php echo e(_i('Salon de télévision')); ?>

                                        </li></div>
                                        <div class="col-lg-6  col-xs-12"><li>
                                            <i class="flaticon2-wifi"></i><?php echo e(_i('Wifi')); ?>

                                        </li></div>
                                        <div class="col-lg-6  col-xs-12"><li>
                                            <i class="flaticon2-transport"></i><?php echo e(_i('Parking')); ?>

                                        </li></div>
                                        <div class="col-lg-6  col-xs-12"><li>
                                            <i class="flaticon2-bed"></i><?php echo e(_i('lit doublé')); ?>

                                        </li></div>
                                        <div class="col-lg-6  col-xs-12"><li>
                                            <i class="flaticon2-old-telephone-ringing"></i><?php echo e(_i('Telephone')); ?>

                                        </li></div>
                                        <div class="col-lg-6  col-xs-12"><li>
                                            <i class="flaticon2-clock"></i><?php echo e(_i('Alarm')); ?>

                                        </li></div>
                                        <div class="col-lg-6  col-xs-12"><li>
                                            <i class="flaticon2-vehicle"></i><?php echo e(_i('Garage')); ?>
                            ...
                            <div class="room-detail widget col-md-6">
                                <h3 class="widget-title"><?php echo e(_i('Chambres luxueusement confortables dans un style ultramoderne !')); ?></h3>
                                <p><?php echo e(_i('Imprégnez-vous de l’atmosphère orientale et de la décoration élégante de nos villas Deluxe. Les chambres sont joliment décorées avec des couleurs profondes qui s’harmonisent avec le bois et l’habillage chic du couloir, créant ainsi un contraste élégant avec la lumière.')); ?><br/>
                                <?php echo e(_i('Chacune des villas offre un confort et un intérieur somptueux, avec des couleurs riches, des tissus épais et des meubles élégants. Cela se combine pour créer un équilibre harmonieux et une atmosphère agréablement chaleureuse. Imaginez-vous confortablement assis sur votre terrasse ou votre balcon en admirant la magnifique vue sur les montagnes de l’Atlas, un spectacle à couper le souffle !')); ?></p>
                ...
                <div class="gallery wrapper clearfix">
                    <div class="container">
                        ...
                        <div class="title text-center wow fadeIn">
                            ...
                            <h2> <?php echo e(_i('NOTRE')); ?> <span class="bold"><?php echo e(_i('GALERIE')); ?></span></h2>
                        </div>
...
<?php $__env->startSection('scripts'); ?>
        <script src="<?php echo e(asset('frontend/js/jquery-1.11.3.min.js')); ?>" type="text/javascript"></script>
        <script src="<?php echo e(asset('frontend/js/jssor.slider-26.7.0.min.js')); ?>" type="text/javascript"></script>
        <script>
            (function() {
